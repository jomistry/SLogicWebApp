angular.module('controllersModule', ['servicesModule'])
    .controller('searchResultsCtrl', ['sharedDataSvc', '$routeParams', '$http', '$location', function (sharedData, $routeParams, $http, $location) {
        ...
        self.getData = function () {
            ...
            $http.get(
                'https://www.quandl.com/api/v3/datasets.json?api_key=8fH3f6QzDf7TrZdRbiFg&database_code=WIKI&query=' + self.pageInfo.query + '&per_page=' + self.pageInfo.per_page + '&page=' + self.pageInfo.current_page
                    ...
                    sharedData.dataSetList = self.datasets;
                })
    ...
    .controller('dataSetCtrl', ['sharedDataSvc', '$routeParams', '$http', function (sharedData, $routeParams, $http) {
        var self = this;
        ...
        sharedData.dataSetList.forEach(function (i) {
            if (i.dataset_code === self.code)
                self.metaData = i;
        });
